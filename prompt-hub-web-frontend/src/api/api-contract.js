(function attachApiContract(global) {
  ...
  const api = Object.freeze({ REQUIRED_METHODS, RESPONSE_CONTRACTS, assertApiContract, assertRecordResponse, assertCollectionResponse, assertAuthResponse, validateApiResponse, wrapApiResponses });
  if (typeof module !== "undefined" && module.exports) module.exports = api;
  global.TtalkakApiContract = api;
  if (typeof window !== "undefined") global.TTALKAK_API = wrapApiResponses(global.TTALKAK_API);
