// @ts-check
(function attachStatePrompt(/** @type {TtalkakGlobal} */ global) {
  "use strict";

const interactionRemovePrompt = global.TtalkakStateDomains?.interaction?.removePromptByIdState;
...
global.TtalkakStateDomains = Object.assign({}, global.TtalkakStateDomains, { prompt: api });
