import { api as persistence } from "./state-persistence.mjs";
import { api as core } from "./state-core.mjs";
import { api as interaction } from "./state-interaction.mjs";
import { api as prompt } from "./state-prompt.mjs";
import { api as admin } from "./state-admin.mjs";
import { api as make } from "./state-make.mjs";

  "use strict";

  const domains = Object.freeze({ persistence, core, interaction, prompt, admin, make });
  ...
  const state = /** @type {TtalkakStateModule} */ (/** @type {unknown} */ (Object.freeze({
    STORAGE_KEY,
    AUTH_TOKEN_KEY,
    DEMO_AUTH_TOKEN,
    addCommentReplyState,
