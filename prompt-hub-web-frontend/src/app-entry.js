...
const modules = Object.freeze({ admin, api, auth, bootstrap, components, demo: demoCopy, discovery: { createDiscoveryController }, effects, events, home, interactions, make, modal, observability: clientErrorReporter, renderers, routing, runtimeConfig, saved: { createMyPageDataModel, createSavedLibraryController }, share, state: { api: state }, utils });
startApp(modules);
