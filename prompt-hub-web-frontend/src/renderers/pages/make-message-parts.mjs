import { normalizeQuestions, normalizeFields, normalizeTechniques, normalizeChanges, parseLegacyQuestions } from "../../utils/make-message-model.mjs";
  ...
  function normalizeMessageTechniques(techniques) {
    return normalizeTechniques(techniques);
  }
  ...
  function normalizeLegacyAskAnswer(text) {
    return parseLegacyQuestions(text);
  }
