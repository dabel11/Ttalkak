(function attachAuthSession(global) {
  "use strict";
  ...
  const api = Object.freeze({ createAuthSession, normalizeAuthResult }); if (typeof module !== "undefined" && module.exports) module.exports = api; global.TtalkakAuthSession = api;
